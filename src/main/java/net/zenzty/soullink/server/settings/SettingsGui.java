...
public class SettingsGui {
    ...
    /**
     * Virtual inventory that tracks pending settings changes. This is a server-side only inventory
     * that doesn't represent any real container in the world.
     */
    ...
    public static class SettingsScreenHandler extends GenericContainerScreenHandler {
                ...
                case CONFIRM_SLOT -> {
                    if (settingsInventory.hasChanges()) {
                        ...
                        Settings.getInstance()
                                .applySnapshot(settingsInventory.getPendingSnapshot());
                        confirmed = true;
        ...
        private void broadcastChanges() {
            ...
            Text headerMsg = Text.empty().append(RunManager.getPrefix())
                    ...
                    .append(Text.literal(" changed settings:").formatted(Formatting.GRAY));
        ...
        public void onClosed(net.minecraft.entity.player.PlayerEntity closingPlayer) {
            ...
            if (!confirmed && settingsInventory.hasChanges()) {
                player.sendMessage(RunManager.formatMessage("Settings changes discarded."), false);
            }
        }
